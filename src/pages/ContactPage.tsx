  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-300 via-blue-150 to-yellow-400">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-24 sm:py-28">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
          ...
          <div className="space-y-6">
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl border-2 border-blue-100">
              <h3 className="text-2xl font-black text-blue-900 mb-6">Contact Information</h3>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-blue-800/70">+91 9000000000</p>
                    <p className="text-blue-800/70">+91 9000000001</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-blue-800/70">info@bcta.org</p>
                    <p className="text-blue-800/70">support@bcta.org</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-blue-800/70">Monday - Saturday: 9:00 AM - 6:00 PM</p>
                    <p className="text-blue-800/70">Sunday: Closed</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* Map Placeholder */}
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-4 shadow-xl border-2 border-blue-100 h-64">
              <div className="w-full h-full bg-blue-100 rounded-xl flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-blue-900 font-medium">Map Location</p>
                  <p className="text-sm text-blue-800/70">Bhimavaram, Andhra Pradesh</p>
                </div>
              </div>
            </div>
          </div>
          ...
          {/* Contact Form */}
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl border-2 border-blue-100">
            <h3 className="text-2xl font-black text-blue-900 mb-6">Send us a Message</h3>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-3 border-2 border-blue-200 rounded-xl focus:outline-none focus:border-blue-500 bg-white/50 backdrop-blur-sm transition"
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  rows={5}
                  className="w-full px-4 py-3 border-2 border-blue-200 rounded-xl focus:outline-none focus:border-blue-500 bg-white/50 backdrop-blur-sm transition resize-none"
              ...
              <button
                type="submit"
                className="w-full bg-blue-600 text-white font-bold py-3 rounded-xl hover:bg-blue-700 transition-all shadow-lg hover:shadow-xl flex items-center justify-center gap-2"
              >
        ...
        {/* Quick Links */}
        <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-8 sm:p-12 border-2 border-blue-200 text-center">
          <h3 className="text-2xl font-black text-blue-900 mb-4">Need Immediate Assistance?</h3>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 border-2 border-blue-600 text-blue-900 bg-white/40 backdrop-blur-sm font-bold px-8 py-3 rounded-xl hover:bg-white/60 transition-all"
            >
              <Phone size={18} />
              Call Now
            </a>
